                  ...
                  if ($count >= 1) {
                    ...
                    foreach ($data as $key => $value) {
                      ...
                      if ($value['extract'] == true) {
                        $editbtn = '<extracter data="'.$namee.'" type="'.$nbr.'"><button type="button" class="btn btn-warning btn-sm" id="Extracting'.$nbr.'">Push to Live</button></extracter>';
                      }else{
                        $editbtn = '<extracter data="'.$namee.'" type="'.$nbr.'"><button type="button" class="btn btn-warning btn-sm" id="Extracting'.$nbr.'">Extract</button></extracter>';
                      }
                      echo "<tr>";
                      ...
                      echo "<td>master</td>";
                      echo '
                        <td><dell data="'.$namee.'" type="'.$nbr.'"><button id="dell'.$nbr.'" type="button" class="btn btn-danger btn-sm">Delete</button></dell>
                        <edit data="'.$namee.'" type="'.$nbr.'"><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-toggle="modal" data-target="#exampleModal">Edit</button></edit>'.$editbtn.'</td>
                      ';
                      echo "</tr>";
                    }
                  }else{
...
<div class="modal fade bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group-prepend">
          <div class="input-group-text">
        	...
        	<div class="input-group input-group-merge">
			  <input type="text" class="form-control form-control-prepended is-valid" id="cloneurl" >
			  <div class="input-group-prepend">
			    <div class="input-group-text">
			      Url
			    </div>
      ...
      <div class="input-group input-group-merge">
			  <input type="text" class="form-control form-control-prepended is-valid" id="ptoken" >
			  <div class="input-group-prepend">
			    <div class="input-group-text">
			      token
			    </div>
      ...
      <div class="row">
        <div class="col">
          <b>Repository Name</b>
          <div class="input-group input-group-merge">
            <input type="text" class="form-control form-control-prepended is-valid" id="GitRepoName">
            <div class="input-group-prepend">
              <div class="input-group-text">
                Name
              </div>
        ...
        <div class="col">
          <b>Repository Branch</b>
          <div class="input-group input-group-merge">
            <input type="text" class="form-control form-control-prepended is-valid" id="GitRepoBranch">
            <div class="input-group-prepend">
              <div class="input-group-text">
                Branch
              </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="closeMod" data-dismiss="modal">Close</button>
